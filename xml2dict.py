...
from lxml.etree import Element, SubElement, tostring, fromstring, XMLParser
...
class _DictSAXHandler(object):
    def __init__(self,
        ...
        self.no_dict = collections.defaultdict(int)
...
if __name__ == '__main__':  # pragma: no cover
    ...
    # with open('1-1.xml') as fd:
    #     xml_str = fd.read()
    #
    # # d = xmltodict.parse(xml_str, dict_constructor=lambda *args, **kwargs: defaultdict(list, *args, **kwargs))
    # d = parse(xml_str)
    ...
    d = {
        "w:p": {
            ...
            "w:r": {
                ...
                "w:t": "翻译 == 实验室面积为1000m2，国际商标™和公司℠版权®。 == 翻译"
            },
            "w:bookmarkEnd": {
                "@w:id": "0"
            }
